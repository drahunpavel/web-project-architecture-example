            ...
            fs.stat(filePath, fileName, (err, stats) => {
                ...
                if (stats.isFile()) {
                    ...
                    if (brokenFile[brokenFile.length - 1] != 'gz') {
                        //нашли сжатый вариант этого файла
                        ...
                        if (сompressedFile) {
                            ...
                            fs.stat(`${filePath}.gz`, сompressedFile, (err, stat) => {
                                ...
                                if (compressedFilebirthtime >= originalFilebirthtime) {
                                    console.log('--compressed file is fine', fileName)
                                } else {
                            ...
                            console.log('--file doesn`t have a compressed version', fileName);
...
async function do_gzip(input, output) {
    ...
    console.log('--create new compressed file', input);
